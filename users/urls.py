...
from .views import UserRegisterView, ProfileUpdateView, Password_Manualy_ChangeView, password_success, ProfileShow
...
urlpatterns = [
    ...
    path('password/', Password_Manualy_ChangeView.as_view(template_name="registration/change_password.html"),
